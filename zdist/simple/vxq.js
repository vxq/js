...
$jscomp.string.codePointAt = function $$jscomp$string$codePointAt$($position$$) {
  ...
  if (0 <= $position$$ && $position$$ < $size$$) {
    ...
    $position$$ = $string$$.charCodeAt($position$$ + 1);
    return 56320 > $position$$ || 57343 < $position$$ ? $first$$ : 1024 * ($first$$ - 55296) + $position$$ + 9216;
  }
};
...
var module$exports$vxq$debug = {assert:function($condition$$, $message$$) {
  ...
  vxq.DEFS.DEBUG && console.log.apply(console, [].concat($jscomp.arrayFromIterable($$jscomp$restParams$$)));
}};
var module$contents$vxq$Vector2D_Vector2D = function $module$contents$vxq$Vector2D_Vector2D$($x$$, $y$$) {
...
module$contents$vxq$Vector2D_Vector2D.from = function $module$contents$vxq$Vector2D_Vector2D$from$($vector$$) {
  return module$contents$vxq$Vector2D_V($vector$$.x, $vector$$.y);
};
module$contents$vxq$Vector2D_Vector2D.prototype.magnitude = function $module$contents$vxq$Vector2D_Vector2D$$magnitude$() {
  return Math.sqrt(this.x * this.x + this.y * this.y);
};
module$contents$vxq$Vector2D_Vector2D.prototype.direction = function $module$contents$vxq$Vector2D_Vector2D$$direction$() {
  return this.withMagnitude(1);
};
module$contents$vxq$Vector2D_Vector2D.prototype.withMagnitude = function $module$contents$vxq$Vector2D_Vector2D$$withMagnitude$($magnitude$$) {
  ...
  return 0 !== $currentMagnitude$$ ? this.scale($magnitude$$ / $currentMagnitude$$) : module$contents$vxq$Vector2D_V(0, 0);
};
...
module$contents$vxq$Vector2D_Vector2D.prototype.subtract = function $module$contents$vxq$Vector2D_Vector2D$$subtract$($other$$) {
  return module$contents$vxq$Vector2D_V(this.x - $other$$.x, this.y - $other$$.y);
};
module$contents$vxq$Vector2D_Vector2D.prototype.addXY = function $module$contents$vxq$Vector2D_Vector2D$$addXY$($x$$, $y$$) {
  return module$contents$vxq$Vector2D_V(this.x + $x$$, this.y + $y$$);
};
module$contents$vxq$Vector2D_Vector2D.prototype.toString = function $module$contents$vxq$Vector2D_Vector2D$$toString$() {
  return "V(" + this.x + ", " + this.y + ")";
};
var module$contents$vxq$Vector2D_V = module$contents$vxq$Vector2D_Vector2D.V = function $module$contents$vxq$Vector2D_Vector2D$V$($x$$, $y$$) {
  return new module$contents$vxq$Vector2D_Vector2D($x$$, $y$$);
}, module$exports$vxq$Vector2D = module$contents$vxq$Vector2D_Vector2D;
...
Object.defineProperties(module$exports$vxq$worlds$turtles.Turtle.prototype, {position:{configurable:!0, enumerable:!0, get:function() {
  return {x:this.x, y:this.y, z:this.z};
}}, xFactor:{configurable:!0, enumerable:!0, get:function() {
...
var $jscomp$destructuring$var0 = module$contents$vxq$Vector2D_Vector2D, module$contents$vxq$worlds$flatland$World_V = module$contents$vxq$Vector2D_Vector2D.V, module$contents$vxq$worlds$flatland$World_World = function $module$contents$vxq$worlds$flatland$World_World$($width$$, $height$$) {
  var $$jscomp$this$$ = this;
  this.width = $width$$;
  this.height = $height$$;
  this.changeCallbacks = new module$exports$vxq$util.CallbackList;
...
var $jscomp$destructuring$var1 = module$contents$vxq$Vector2D_Vector2D, module$contents$vxq$worlds$flatland$Unit_V = module$contents$vxq$Vector2D_Vector2D.V, module$contents$vxq$worlds$flatland$Unit_Unit = function $module$contents$vxq$worlds$flatland$Unit_Unit$($world$$, $x$$, $y$$) {
  this.world = $world$$;
...
module$contents$vxq$worlds$flatland$Unit_Unit.prototype.goTo = function $module$contents$vxq$worlds$flatland$Unit_Unit$$goTo$($p$$) {
...
var $jscomp$destructuring$var2 = module$contents$vxq$Vector2D_Vector2D, module$contents$vxq$worlds$flatland_V = module$contents$vxq$Vector2D_Vector2D.V, module$exports$vxq$worlds$flatland = {World:module$contents$vxq$worlds$flatland$World_World, Unit:module$contents$vxq$worlds$flatland$Unit_Unit, Vector:module$contents$vxq$Vector2D_Vector2D, V:module$contents$vxq$worlds$flatland_V};
...
var $jscomp$destructuring$var3 = module$contents$vxq$Vector2D_Vector2D, module$contents$vxq$uis$FlatCanvas_V = module$contents$vxq$Vector2D_Vector2D.V, module$contents$vxq$uis$FlatCanvas_AgentRender = function $module$contents$vxq$uis$FlatCanvas_AgentRender$($renderer$$, $agent$$) {
  var $$jscomp$this$$ = this;
  this.totalDistance = 0;
  this.hueSeed = 1E3 * Math.random();
  this.lastPosition = module$contents$vxq$uis$FlatCanvas_V(0, 0);
  this.renderer = $renderer$$;
  this.agent = $agent$$;
  this.cancel = $agent$$.changeCallbacks.add(function() {
    return void $$jscomp$this$$.update($agent$$.position);
  });
};
module$contents$vxq$uis$FlatCanvas_AgentRender.prototype.update = function $module$contents$vxq$uis$FlatCanvas_AgentRender$$update$($distance$$4_opacity_position$$) {
  $distance$$4_opacity_position$$ = void 0 === $distance$$4_opacity_position$$ ? this.lastPosition : $distance$$4_opacity_position$$;
  if (module$exports$vxq$util.elementInView(this.renderer.canvas)) {
    $distance$$4_opacity_position$$ = this.lastPosition.subtract($distance$$4_opacity_position$$).magnitude();
    $distance$$4_opacity_position$$ = Math.max(.2, Math.min(1, $distance$$4_opacity_position$$ / 100));
    var $g$$ = this.renderer.context;
    $g$$.fillStyle = "hsla(" + this.hueSeed + ", 50%, 50%, " + $distance$$4_opacity_position$$ + ")";
    $g$$.strokeStyle = "rgba(255, 255, 255, " + $distance$$4_opacity_position$$ + ")";
    $g$$.beginPath();
    $g$$.lineWidth = 1;
    $g$$.arc(this.agent.position.x, this.agent.position.y, 6, 0, 2 * Math.PI);
    $g$$.fill();
    $g$$.stroke();
    $g$$.strokeStyle = "rgba(0, 0, 0, " + .5 * $distance$$4_opacity_position$$ + ")";
    $g$$.beginPath();
    $g$$.lineWidth = 2;
...
var module$contents$vxq$uis$FlatCanvas_Pointer = function $module$contents$vxq$uis$FlatCanvas_Pointer$($world$$, $source$$, $x$$, $y$$) {
  ...
  this.canvas.width = Math.min(this.world.dimensions.x, 1E3);
  this.canvas.height = Math.min(this.world.dimensions.y, 1E3);
  ...
  this.canvas.addEventListener("click", function($event_y$$) {
    ...
    if ($lastAgent$$) {
      ...
      $lastAgent$$.goTo(module$contents$vxq$uis$FlatCanvas_V($x$$, $event_y$$)).then(function() {
...
module$exports$vxq$uis$FlatCanvas.prototype.tick = function $module$exports$vxq$uis$FlatCanvas$$tick$($$jscomp$iter$6$$1_$jscomp$iter$7$$1_dt$$) {
  if (module$exports$vxq$util.elementInView(this.canvas)) {
    ...
    this.context.fillStyle = "black", this.context.fillRect(0, 0, this.canvas.width, this.canvas.height);
  }
};
...
var $jscomp$destructuring$var4 = module$contents$vxq$Vector2D_Vector2D, module$contents$vxq$main_V = module$contents$vxq$Vector2D_Vector2D.V, module$contents$vxq$main_VXQModule = function $module$contents$vxq$main_VXQModule$() {
};
...
module$contents$vxq$main_VXQModule.prototype.addFlatCanvasWithFlatland = function $module$contents$vxq$main_VXQModule$$addFlatCanvasWithFlatland$($element$$6_r$$) {
  ...
  $i$$14_ui$$.velocity = module$contents$vxq$main_V(200, -5);
  $world$$.units.add($i$$14_ui$$);
  console.log($i$$14_ui$$.goTo(module$contents$vxq$main_V(500, 500)));
  $i$$14_ui$$ = new module$exports$vxq$worlds$flatland.Unit($world$$, 400, 200);
  $i$$14_ui$$.velocity = module$contents$vxq$main_V(-100, 450);
  $world$$.units.add($i$$14_ui$$);
  console.log($i$$14_ui$$.goTo(module$contents$vxq$main_V(25, 25)));
  $i$$14_ui$$ = new module$exports$vxq$worlds$flatland.Unit($world$$, 150, 175);
  $i$$14_ui$$.velocity = module$contents$vxq$main_V(-65, 125);
  $world$$.units.add($i$$14_ui$$);
  console.log($i$$14_ui$$.goTo(module$contents$vxq$main_V(50, 400)));
  for ($i$$14_ui$$ = 0;4 > $i$$14_ui$$;$i$$14_ui$$++) {
    ...
    $planetComponent$$.velocity = module$contents$vxq$main_V(5 - 10 * $element$$6_r$$(), 5 - 10 * $element$$6_r$$());
