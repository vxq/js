...
function $module$contents$vxq$worlds$flatland$World_World$$($width$$13$$, $height$$12$$) {
  ...
  setInterval(function() {
    ...
    for ($$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$ = $$jscomp$iter$3$$inline_28_unit$$inline_19$$.next();!$$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.done;$$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$ = $$jscomp$iter$3$$inline_28_unit$$inline_19$$.next()) {
      ...
      $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$ = $$jscomp$key$other$$inline_22_f$$inline_31_fG$$inline_26_other$$inline_23$$.scale(.02 / $$jscomp$iter$1$$inline_21_dP$$inline_35_inertia$$inline_30$$), $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$ = $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$.add($dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$), $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$ = 
      $JSCompiler_StaticMethods_magnitude$$($$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$), $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$ = Math.max(0, $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$ - .001 * $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$), $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$ = 4 <= $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$ || 
      4 < $JSCompiler_StaticMethods_magnitude$$($$jscomp$key$other$$inline_22_f$$inline_31_fG$$inline_26_other$$inline_23$$) / $$jscomp$iter$1$$inline_21_dP$$inline_35_inertia$$inline_30$$ ? $JSCompiler_StaticMethods_withMagnitude$$($$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$, $dV$$inline_32_displacement$$inline_24_newSpeed$$inline_34_speed$$inline_33$$) : $module$contents$vxq$worlds$flatland$Vector_Vector$V$$(0, 0), 0 < $JSCompiler_StaticMethods_magnitude$$($$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$) && 
      ($$jscomp$iter$1$$inline_21_dP$$inline_35_inertia$$inline_30$$ = $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$a$.scale(.02), $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$b$ = $$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$.$b$.add($$jscomp$iter$1$$inline_21_dP$$inline_35_inertia$$inline_30$$), $$jscomp$iter$2$$inline_17_changedUnits$$inline_27$$.push($$jscomp$key$unit$$inline_18_force$$inline_20_unit$11$$inline_29$$));
    }
...
function $module$contents$vxq$worlds$flatland$Unit_Unit$$($world$$, $x$$83$$, $y$$54$$) {
...
;function $module$contents$vxq$uis$FlatCanvas_AgentRender$$($renderer$$, $agent$$) {
...
$module$contents$vxq$uis$FlatCanvas_AgentRender$$.prototype.update = function $$module$contents$vxq$uis$FlatCanvas_AgentRender$$$$update$($deltaX_g_x$$85$$, $deltaY_y$$56$$, $deltaZ_opacity_z$$15$$) {
...
function $module$contents$vxq$uis$FlatCanvas_Pointer$$($source$$12$$, $x$$86$$, $y$$57$$) {
  this.source = $source$$12$$;
  this.x = $x$$86$$;
  this.y = $y$$57$$;
}
function $module$exports$vxq$uis$FlatCanvas$$($world$$2$$) {
  ...
  this.$a$.addEventListener("click", function($event_y$$58$$) {
    ...
    if ($lastAgent$$) {
      var $pointer$$ = new $module$contents$vxq$uis$FlatCanvas_Pointer$$($lastAgent$$, $x$$87$$, $event_y$$58$$);
  ...
  var $then$$ = +new Date;
  setInterval(function() {
    var $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ = +new Date, $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = ($$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ - $then$$) / 1E3;
    $then$$ = $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$;
    if ($module$exports$vxq$util$elementInView$$($$jscomp$this$$4$$.$a$)) {
      $$jscomp$this$$4$$.$b$.fillStyle = "rgba(0, 0, 0, " + .25 * $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ + ")";
      $$jscomp$this$$4$$.$b$.fillRect(0, 0, $$jscomp$this$$4$$.$c$.width, $$jscomp$this$$4$$.$c$.height);
      $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ = Array.from($$jscomp$this$$4$$.$f$.values());
      $module$exports$vxq$util$shuffle$$($$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$);
      $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ = $$jscomp$makeIterator$$($$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$);
      for ($$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$.next();!$$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.done;$$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$.next()) {
        $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.value.update();
      }
      $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ = Array.from($$jscomp$this$$4$$.$g$);
      $module$exports$vxq$util$shuffle$$($$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$);
      $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$ = $$jscomp$makeIterator$$($$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$);
      for ($$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$.next();!$$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.done;$$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = $$jscomp$iter$6$$inline_44_$jscomp$iter$7$$inline_47_now_pointers$$inline_46_renders$$inline_43$$.next()) {
        $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$ = $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.value, $$jscomp$this$$4$$.$b$.strokeStyle = "rgba(210, 40, 40, 0.75)", $$jscomp$this$$4$$.$b$.beginPath(), $$jscomp$this$$4$$.$b$.lineWidth = 4, $$jscomp$this$$4$$.$b$.moveTo($$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.source.x, $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.source.y), 
        $$jscomp$this$$4$$.$b$.lineTo($$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.x, $$jscomp$key$pointer$$inline_48_$jscomp$key$render$$inline_45_dt$$1_pointer$$inline_49$$.y), $$jscomp$this$$4$$.$b$.stroke();
      }
    } else {
...
$module$exports$vxq$uis$FlatCanvas$$.prototype.$h$ = function $$module$exports$vxq$uis$FlatCanvas$$$$$h$$() {
  for (var $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$ = $$jscomp$makeIterator$$(this.$f$), $$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$ = $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$.next();!$$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$.done;$$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$ = $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$.next()) {
    $$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$.value.cancel();
  }
  this.$f$ = new Map;
  $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$ = $$jscomp$makeIterator$$(this.$c$.agents);
  for ($$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$ = $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$.next();!$$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$.done;$$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$ = $$jscomp$iter$8$$1_$jscomp$iter$9$$1$$.next()) {
    $$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$ = $$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$.value, this.$f$.set($$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$, new $module$contents$vxq$uis$FlatCanvas_AgentRender$$(this, $$jscomp$key$agent_$jscomp$key$render$$1_agent$$1$$));
  }
};
...
$module$contents$vxq$main_VXQModule$$.prototype.addFlatCanvasWithTurtles = function $$module$contents$vxq$main_VXQModule$$$$addFlatCanvasWithTurtles$($element$$5$$) {
  var $world$$3$$ = new $module$exports$vxq$worlds$turtles$World$$(512, 512, []), $ui$$ = new $module$exports$vxq$uis$FlatCanvas$$($world$$3$$);
  $element$$5$$.appendChild($ui$$.$a$);
...
$module$contents$vxq$main_VXQModule$$.prototype.addFlatCanvasWithFlatland = function $$module$contents$vxq$main_VXQModule$$$$addFlatCanvasWithFlatland$($element$$6_i$$14_unit1_unit2_unit3$$) {
  ...
  var $world$$4$$ = new $module$contents$vxq$worlds$flatland$World_World$$(512, 512), $planetComponent_ui$$1$$ = new $module$exports$vxq$uis$FlatCanvas$$($world$$4$$);
  $element$$6_i$$14_unit1_unit2_unit3$$.appendChild($planetComponent_ui$$1$$.$a$);
  ...
  for ($element$$6_i$$14_unit1_unit2_unit3$$ = 0;4 > $element$$6_i$$14_unit1_unit2_unit3$$;$element$$6_i$$14_unit1_unit2_unit3$$++) {
    $planetComponent_ui$$1$$ = new $module$contents$vxq$worlds$flatland$Unit_Unit$$(0, 200 + 50 * $r$$1$$(), 200 + 50 * $r$$1$$()), $planetComponent_ui$$1$$.$c$ *= 10, $planetComponent_ui$$1$$.$f$ *= 10, $planetComponent_ui$$1$$.$a$ = $module$contents$vxq$worlds$flatland$Vector_Vector$V$$(5 - 10 * $r$$1$$(), 5 - 10 * $r$$1$$()), $world$$4$$.$a$.add($planetComponent_ui$$1$$);
  }
